...
export default VyonaNavbar;`
  ...
  {
    id: 6,
    title: "Magical Modal - Glassmorphed",
    description: 
      "A glowing glassmorphed modal that is made with GSAP animation and fades and scales with it and makes a blurred background",
    type: "modal",
    code: `import React, { useEffect, useRef } from "react";
import { gsap } from "gsap";
